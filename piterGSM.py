        ...
        for i in data:
            ...
            for card in cards:
                ...
                try:
                    ...
                    url_page = 'https://pitergsm.ru' + card.find('div', class_="prod-card").find('a', class_="prod-card__link").get('href')
        ...
        try:
            ...
            for key, value in massive.items():
                for url in value:
                        ...
                        scr = response.text
                        with open(f'data_html/{count}_{key}.html', 'w', encoding='utf-8') as file:
                            file.write(scr)
